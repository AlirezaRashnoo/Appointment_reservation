    ...
    return (
        <>
            <header className="bg-white fixed top-0 w-full z-50 ">
                {/* header mobile */}
                <div className="py-6 border-b border-gray-300 z-40 md:hidden">
                        ...
                        <div className={`${isShowSearchBox ? "top-1/2 bottom-1/2":"-top-[149px]"} transition-all duration-200 fixed w-11/12 h-[149px] p-4 bg-white z-50 rounded-2xl`}>
                            <div className="space-y-8">
                                ...
                                <div className="flex items-center justify-between bg-gray-200 h-14 rounded-lg overflow-hidden">
                                    <input type="text" className="w-full px-2 bg-gray-200" placeholder="جستجوی دندانپزشکان ..." maxLength=""/>
                ...
                <div className="hidden bg-white py-8 shadow-Main md:block">
            ...
            <div className={`${isShowSearchBox || isShowMenu ?"h-full":""} fixed top-0 w-full bg-black/60 z-40`} onClick={()=> setIsShowMenu(false)}></div>
            <div className={`fixed h-full top-0 z-50 w-64 ${isShowMenu? "right-0":"-right-[300px]"}  ml-auto bg-white p-3 transition-all duration-300`}>
