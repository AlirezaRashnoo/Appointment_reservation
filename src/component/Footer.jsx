...
function Footer() {
    ...
    return ( 
        <footer className="mt-40 pb-12 bg-white">
                    ...
                    <div className="relative bg-blue-500 h-full">
                        ...
                        <div className="">
                            <div className="container">
                                <div>
                                    <span className="text-base block py-6 text-white">به جمع هزاران دندانپزشک ما بپیوندید</span>
                                    <Button href="#" className="inline-block w-[140px] h-9 py-2.5 px-5 bg-white rounded-[100px] text-xs text-black mr-4">
                                        ثبت نام دندانپزشکان
                                    </Button>
                                </div>
                                <img src="../images/image-dentist-footer.png" alt="dentist-image" className="absolute bottom-0 w-[120px] left-3.5"/>
                            </div>
                            <div className="pb-16 bg-white relative w-full">
                                <div className="container">
                                        ...
                                        <div className="md:w-1/2">
                                            ...
                                            <form>
                                                <div className="relative border border-secoundColor rounded-[100px] overflow-hidden bg-white block">
                                                    <input type="text" className="bg-white h-11 w-[69%] text-xs m-1 p-2.5" placeholder="شماره موبایل خود را وارد کنید" maxLength=""/>
                                    ...
                                    <div className="md:flex items-center justify-between">
                                        ...
                                        <div className="flex items-center justify-between h-[110px] max-h-full my-8 gap-x-3">
                                    ...
                                    <div className="text-center p-4 text-white text-xs bg-blue-400 leading-6 mt-4">
                                        مسئولیت صحت آگهی های درج شده در این سایت بعهده آگهی دهنده میباشد. تمام حقوق و محتویات این سایت متعلق به علیرضا رشنو میباشد و هرگونه کپی برداری بدون ذکر منبع پیگرد قانونی دارد ©
                                    </div>
                                </div>
                            </div>
                        </div>
