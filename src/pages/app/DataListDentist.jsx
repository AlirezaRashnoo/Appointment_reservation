...
//   if (fetchError) {
//     console.error("خطا در گرفتن view_count:", fetchError.message);
//     return;
//   }

//   const currentCount = profileData?.view_count ?? 0;
...
//   if (updateError) {
//     console.error("خطا در آپدیت view_count:", updateError.message);
//     return;
//   }

//   // اختیاری: به‌روزرسانی state برای نمایش فوری
//   setProfileDentist((prev) =>
...
// //   if (loading) return <BeatLoader className="w-full h-screen"/>
//   if (loading) return (
...
//     {/* <p className="text-black">تعداد بازدیدها: {profileDentist.view_count ?? 0}</p> */}
//         <div className="">
//             <div className="h-40">
...
//                         <textarea
//                             className="w-full h-[131px] outline-none resize-none bg-white"
//                             rows={6}
//                             value={content}
